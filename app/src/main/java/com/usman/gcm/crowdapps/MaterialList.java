...
/**
 * Created by usman on 6/18/15.
 */
public class MaterialList extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.material_list_main);
    ...
    private void fillArray() {
        ...
        for (int i = 0; i < 35; i++) {
            ...
            Log.e("Card Random: " , card.toString());
    ...
    private Card getRandomCard(final int position) {
        ...
        switch (type) {
            ...
            case 2:
                ...
                card.setDescription(description);
                card.setTitle(title);
                card.setDrawable(R.drawable.jira111x30);
            ...
            default:
                ...
                card.setDescription(description);
                card.setTitle(title);
                card.setDrawable(R.drawable.download);
